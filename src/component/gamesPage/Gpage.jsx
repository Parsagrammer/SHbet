...
<Link className="p-3 m-3 " to={'/'} ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi text-danger border-pill border-1 m-3 bi-arrow-bar-left" viewBox="0 0 16 16">
...
<div className="row p-4" >
{
 infoGames.games.map((e,i)=>{
        return <Link key={i} className=" w-75 text-decoration-none  text-center m-3 fs-1" to={`${i}`}  >
